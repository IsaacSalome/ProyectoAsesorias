<div class="py-12">
    <div class="mx-auto max-w-7x1 sm:px6 lg:px-8">
        <div class="px-4 py-4 overflow-auto bg-white shadow-xl sm:rounded-lg">
            ...
            @if ($modal)
                @include('livewire.administrador.registrar-alumno.crear')
            @endif
